...
const PHASES = [
  {
    ...
    detail: 'wedding • birthday • engagement • corporate event',
  },
  {
    number: '02',
      ...
      <div className={`services__flow ${inView ? 'visible' : ''}`}>
        ...
        <aside className="services__rail">
          ...
          <div className="services__contact">
            ...
            <a className="services__contact-link" href="mailto:eventbyrohinprivateltd@gmail.com">
            ...
            <a
              ...
              href="https://www.facebook.com/search/top/?q=Event%20by%20Rohin%20at%20jaffna"
              target="_blank"
