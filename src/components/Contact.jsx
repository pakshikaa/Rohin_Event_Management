  ...
  return (
    <section className="contact" id="contact" ref={ref}>
      <div className={`contact__inner ${inView ? 'visible' : ''}`}>
        <p className="contact__eyebrow">VIP Concierge</p>
        ...
        <p className="contact__sub">
          Share your date, venue, and event type. Our team will guide you with a refined
          decoration concept that fits your celebration.
        </p>

        <div className="contact__actions">
          <a
            href="https://wa.me/94767171454?text=Hello%20Rohin%2C%20I%20would%20like%20to%20discuss%20an%20upcoming%20event."
            target="_blank"
        ...
        <div className="contact__details">
          <div className="contact__detail">
            ...
            <span className="contact__detail-value">Jaffna, Sri Lanka</span>
          </div>
          ...
          <div className="contact__detail">
            ...
            <a href="mailto:eventbyrohinprivateltd@gmail.com" className="contact__detail-value contact__detail-link">eventbyrohinprivateltd@gmail.com</a>
          </div>
        </div>
      </div>
