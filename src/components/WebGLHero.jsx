...
const fragmentShader = `
  ...
  void main() {
    ...
    // Calm obsidian-sage base
    vec3 col = vec3(0.055, 0.062, 0.055);

    // Soft layered atmospheric noise
    ...
    // Large soft glows for a trendy calm luxury background
