...
const SCENARIOS = [
  {
    id: 1,
    label: 'Wedding Hall',
    title: 'Wedding Hall Transformation',
    beforeImage: '/images/transformation/wedding-before.png',
    afterImage: '/images/transformation/wedding-after.png',
    accent: '#dcb79b',
    proof: 'Every transformation begins with a consultation. Begin yours',
  },
  {
    id: 2,
    label: 'Corporate Stage',
    title: 'Corporate Stage Transformation',
    ...
    >
      <div className="meta__scene meta__scene--before">
        <img
          ...
          alt={`${scenario.title} before transformation view`}
          draggable="false"
        />
        <div className="meta__dust" />
        <span className="meta__label meta__label--before">Before</span>
      </div>
      ...
      <div className="meta__scene meta__scene--after" style={{ clipPath: `inset(0 ${100 - position}% 0 0)` }}>
        <img
          ...
          alt={`${scenario.title} after Rohin styling`}
          draggable="false"
        />
        <div className="meta__lights" style={{ '--meta-accent': scenario.accent }} />
        <span className="meta__label meta__label--after">After Rohin</span>
      </div>
    ...
    <section className="meta" id="metamorphosis" ref={ref}>
      <div className={`meta__inner ${inView ? 'visible' : ''}`}>
        <div className="meta__header">
          <p className="meta__eyebrow">Metamorphosis</p>
          <h2 className="meta__headline">See a room move from empty structure to finished experience.</h2>
        </div>
        ...
        <div className="meta__footnote">
          ...
          >
            {scenario.proof} <span aria-hidden="true">&rarr;</span>
          </a>
        </div>
      </div>
    </section>
